                        ...
                        <div class="container">
                            <ul class="children">
                                <li v-for="(item,i) of activeNav" :key="i">
                                    <router-link :to="{name:'Product', query:{pid:item.pid}}">
                                        <div class="figure">
...
export default {
  ...
  data() {
      return {
          ...
          keylist:false,
          navItemActive:false,
          navItem:[{id:1,name:"小米手机"},{id:2,name:"Redmi 红米"},{id:3,name:"电视"},{id:4,name:"笔记本"},{id:5,name:"家电"},{id:6,name:"路由器"},{id:7,name:"智能硬件"}],
          navProduct:[{cid:1,pid:2,name:"小米10 Pro",price:3999,src:"product1.webp"},{cid:1,pid:1,name:"小米10",price:2999,src:"product2.webp"},{cid:1,pid:1,name:"小米10 青春版",price:1999,src:"product3.webp"},{cid:1,pid:2,name:"小米Mix alpha",price:4999,src:"product4.webp"},{cid:2,pid:3,name:"Redmi K30 至尊纪念版",price:1999,src:"product5.webp"},{cid:2,pid:3,name:"Redmi K30 Pro 系列",price:2699,src:"product6.webp"},{cid:2,pid:3,name:"Redmi K30 系列",price:1399,src:"product7.webp"},{cid:2,pid:3,name:"Redmi 10X 5G",price:1599,src:"product8.webp"},{cid:2,pid:3,name:"Redmi Note 8",price:899,src:"product9.webp"},{cid:2,pid:3,name:"Redmi 9",price:799,src:"product10.webp"},{cid:3,pid:9,name:"小米电视 大师 65英寸OLED",price:12999,src:"product11.webp"},{cid:3,pid:9,name:"Redmi 智能电视 MAX 98''",price:19999,src:"product12.webp"},{cid:3,pid:9,name:"小米电视4A 60英寸",price:1899,src:"product13.webp"},{cid:3,pid:9,name:"Redmi 智能电视 X55",price:2899,src:"product14.webp"},{cid:3,pid:9,name:"Redmi 红米电视 70英寸 R70A",price:2888,src:"product15.webp"},{cid:3,pid:9,name:"小米壁画电视 65英寸",price:6899,src:"product16.jpg"},{cid:4,pid:9,name:"RedmiBook 16",price:4899,src:"product16.webp"},{cid:4,pid:9,name:"RedmiBook 14 Ⅱ",price:4499,src:"product17.png"},{cid:5,pid:24,name:"米家互联网空调C1（一级能效）",price:1899,src:"product18.png"},{cid:6,pid:24,name:"Redmi路由器 AX6",price:399,src:"product19.webp"},{cid:7,pid:24,name:"小米米家智能摄像机云台版",price:179,src:"product20.jpg"},{cid:7,pid:24,name:"小米小爱老师",price:399,src:"product21.jpg"}],
          activeNav:[],
