        ...
        <div class="container">
                    ...
                    <div class="span16">
                        <ul class="brick-list clearfix">
                            ...
                            <li class="brick-item">
                                <a href="">
                                    <div class="figure">
                                        <img src="images/brick-list2.webp" alt="">
                                    </div>
                                    <h3 class="title">
                                        小米10 青春版 5G
                                    </h3>
                            ...
                            <li class="brick-item">
                                <a href="">
                                    <div class="figure">
                                        <img src="images/brick-list4.webp" alt="">
                                    </div>
                                    <h3 class="title">
                                        小米10 青春版 5G
                                    </h3>
                            ...
                            <li class="brick-item">
                                <a href="">
                                    <div class="figure">
                                        <img src="images/brick-list5.webp" alt="">
                                    </div>
                                    <h3 class="title">
                                        小米10 青春版 5G
                                    </h3>
                            ...
                            <li class="brick-item">
                                <a href="">
                                    <div class="figure">
                                        <img src="images/brick-list7.webp" alt="">
                                    </div>
                                    <h3 class="title">
                                        小米10 青春版 5G
                                    </h3>
                            ...
                            <li class="brick-item">
                                <a href="">
                                    <div class="figure">
                                        <img src="images/brick-list8.webp" alt="">
                                    </div>
                                    <h3 class="title">
                                        小米10 青春版 5G
                                    </h3>
            ...
            <div class="home-brick-box xm-plain-box">
                ...
                <div class="box-bd clearfix">
                    <div class="span4">
                        <ul class="brick-promo-list">
                            <li class="brick-item brick-item-m"><a href="">
...
.page-main .home-brick-box .span4{
    margin-left: 0;
}
.page-main .home-brick-box .span4 .brick-item{
    float: left;
    margin-bottom: 14px;
